                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center '>
                            ...
                            <div className='relative bg-gray-900/90 backdrop-blur-sm border border-green-500/30 rounded-2xl overflow-hidden shadow-2xl'>
                                ...
                                <div className='p-3 sm:p-4 md:p-6 font-mono text-xs sm:text-sm bg-gradient-to-br from-gray-900/50 to-black/50 max-h-[350px] sm:max-h-[400px] overflow-hidden'>
                                    {codeLines.map((line, index) => (
                                        <div
                                            key={index}
                                            className={`transition-all duration-500 flex items-start mb-1 ${index < currentLine
                    ...
                    <div className='space-y-4 sm:space-y-6'>
                        <div className='space-y-3 sm:space-y-4 text-gray-300 font-roboto text-sm sm:text-base md:text-lg leading-relaxed'>
                            <p>
                                I’m a driven <span className='text-green-400 font-semibold'>Full-Stack Engineer</span> dedicated to architecting high-performance web applications. I specialize in the MERN stack, bridging the gap between sophisticated frontend design and robust DevOps infrastructure.
                            </p>
                            <p>
                                My transition into tech was fueled by an innate curiosity to deconstruct complex systems, a passion that has evolved into a professional commitment to building seamless, scalable digital experiences.
                            </p>
                            <p>
                                Beyond the IDE, I am <strong>always curious to learn from the expertise of others</strong> and stay ahead of emerging frameworks. I thrive on collaborating with the developer community and exploring new ways to optimize the modern web.
                            </p>
                        </div>
