            ...
            <div className="flex justify-center gap-4 mb-16 relative z-20 ">
                {['All', 'Full Stack', 'Frontend'].map((cat) => (
                    <button
                        ...
                        className={`px-8 py-2 rounded-full text-[10px] sm:text-sm font-roboto cursor-pointer transition-all duration-300 border ${filter === cat
                        ...
                        <SwiperSlide key={project.id} className="h-full pb-2">
                            ...
                            >
                                ...
                                <div className="p-8 flex-grow flex flex-col justify-between">
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-6">
                                            {project.tags.slice(0, 6).map(tag => (
                                                <span key={tag} className="px-3 py-1 bg-zinc-900 text-zinc-500 text-xs rounded-lg border border-zinc-800">
                                                    {tag}
                                                </span>
                                            ))}
                                        </div>
                                    ...
                                    >
                                        <FaGithub size={18} className="text-zinc-500 group-hover/code:text-green-500 transition-colors" />
